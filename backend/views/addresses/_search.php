...
/* @var $model backend\models\addressesSearche */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="addresses-search ibox-heading row search" style="margin-top: 5px;padding-top:5px">
    ...
    <?= $form->field($model, 'address', ['labelOptions'=>['class'=>'col-sm-4 control-label'], 'size'=>8, 'options'=>['class'=>'col-sm-3']]) ?>
