...
/* @var $model backend\models\search\VideoSearche */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="video-search ibox-heading row search" style="margin-top: 5px;padding-top:5px">
    ...
    <?= $form->field($model, 'url', ['labelOptions'=>['class'=>'col-sm-4 control-label'], 'size'=>8, 'options'=>['class'=>'col-sm-3']]) ?>
